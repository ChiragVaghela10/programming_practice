    ...
    while True:
        ...
        if userInput == '.':
            ...
            if isValidWord(userInput, hand, wordList):
                currentScore = getWordScore(userInput, n)
                totalScore += currentScore
                hand = updateHand(hand, userInput)
                print ('"', userInput, '" earned ', currentScore, ' points. Total: ', totalScore, ' points\n')
                if not sum(hand.values()):
                    #or you may use calculateHandlen(hand)
